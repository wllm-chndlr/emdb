export default function(server) {
    server.create("movie", {
      ...
      server.create("movie", {
        title: "Pulp Fiction",
        posterUrl:
          "https://i.pinimg.com/originals/4b/b6/03/4bb60346994dc4d0fa08b6e901e4e57b.jpg",
        description:
      ...
      server.create("movie", {
        ...
        posterUrl:
          "https://m.media-amazon.com/images/M/MV5BMTY1MTE4NzAwM15BMl5BanBnXkFtZTcwNzg3Mjg2MQ@@._V1_.jpg",
        description:
      ...
      server.create("movie", {
        title: "Snowpiercer",
        posterUrl:
          "https://m.media-amazon.com/images/M/MV5BOTdjM2NmZTgtYTFlMS00ZWE1LWExNzItZWEyZGE3NjE3OWQ5XkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_SY1000_CR0,0,674,1000_AL_.jpg",
        description:
